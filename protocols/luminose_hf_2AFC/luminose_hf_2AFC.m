        ...
        for currentTrial = 1:S.GUI.maxTrials
            try
                ...
                if ~isempty(fieldnames(RawEvents))
                    ...
                    % For response: 1=Left, 2=Right, NaN=NoResp
                    % In 2AFC, we can use events to determine actual response side
        ...
        for currentTrial = 1:S.GUI.maxTrials
            try
                ...
                if ~isempty(fieldnames(RawEvents))
                    ...
                    outcome = getTrialOutcome_hf_2AFC(BpodSystem.Data, currentTrial);
                    BpodSystem.Data.Custom.TrialOutcome(currentTrial) = outcome;
                    % Emulator response logic
                    if outcome == 1, BpodSystem.Data.Custom.TrialResponse(currentTrial) = currentTrialType;
                    elseif outcome == 0, BpodSystem.Data.Custom.TrialResponse(currentTrial) = 3 - currentTrialType;
                    else BpodSystem.Data.Custom.TrialResponse(currentTrial) = NaN; end
    ...
    switch emulator
        case true
            ...
            sma = AddState(sma, 'Name', 'getResponse', ...
                ...
                'StateChangeConditions', {'Port1In', leftAction, 'Port2In', rightAction, 'Tup', 'InterTrialInterval'},...
