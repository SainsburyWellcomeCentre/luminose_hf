function luminose_hf_playground
    ...
    % livePsychometricPlot_hf_playground(BpodSystem.GUIHandles.PsychometricAxes, 'init', [], [1]);
    ...
    if ~emulator
        ...
        for currentTrial = 1:S.GUI.maxTrials
            try
                t1 = tic;
                S = LuminoseParameterGUI_hf_playground('sync', S); % Sync parameters with LuminoseParameterGUI_hf_playground plugin
                currentTrialType = nextTrialType;
                
                % Use robust bias correction and error repeating
                ...
                if ~isempty(fieldnames(RawEvents))
                    ...
                    % Process trial data for bias correction
                    ...
                    % livePsychometricPlot_hf_playground(BpodSystem.GUIHandles.PsychometricAxes, 'update', ...
                    %     BpodSystem.Data, [1]);
                    t5 = tic;
