function GUIparams_luminose_hf_2AFC()
    ...
    % == Pattern ==
    S.GUI.Nimages_cue = 4;
    S.GUI.imgIdx_cue = [1, 2, 3, 4];
    S.GUI.exposure_cue = [1e+6, 1e+6, 1e+6, 1e+6];
    S.GUI.dark_cue = [0, 0, 0, 0];
    S.GUI.repeat_cue = 1;

    %% ===== Left =====
    S.GUITabs.Left = {'Light', 'Sound', 'Pattern', 'Odour'};
    S.GUIPanels.Odour = {'valves_Left', 'dutyCycles_Left', 'label_Left'};
    S.GUIPanels.Sound = {'Amplitude_Left', 'HighFreq_Left', 'LowFreq_Left'};
    S.GUIPanels.Light = {'Intensity_Left'};
    S.GUIPanels.Pattern = {'Nimages_Left', 'imgIdx_Left', 'exposure_Left', 'dark_Left', 'repeat_Left'};
    % == Odour ==
    ...
    %% ===== Right =====
    S.GUITabs.Right = {'Light', 'Sound', 'Pattern', 'Odour'};
    S.GUIPanels.Odour = {'valves_Right', 'dutyCycles_Right', 'label_Right'};
    S.GUIPanels.Sound = {'Amplitude_Right', 'HighFreq_Right', 'LowFreq_Right'};
    S.GUIPanels.Light = {'Intensity_Right'};
    S.GUIPanels.Pattern = {'Nimages_Right', 'imgIdx_Right', 'exposure_Right', 'dark_Right', 'repeat_Right'};
    % == Odour ==
